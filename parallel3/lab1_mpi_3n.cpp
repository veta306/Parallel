...
int main(int argc, char **argv)
{
  ...
  int basePartSize = arraySize / numWorkers;
  int remainingElements = arraySize % numWorkers;
  int current_idx = 0;
  ...
  for (int i = 1; i < world_size; i++)
  {
    ...
    send_counts[i] = basePartSize + (worker_idx < remainingElements ? 1 : 0);
